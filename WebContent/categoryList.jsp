...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<html>
		...
		<script>		
			document.getElementById('reload').addEventListener('mouseout', () => {
			  location.reload();
			});
		</script>
	</html>
